      ...
      <Content>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Terror LLC.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Terror, accessible from{' '}
              <a
                href="https://terror.llc"
        ...
        <ul>
          <li>
            ...
            <a
              href="https://terror.llc/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://terror.llc/contact
            </a>
          </li>
        </ul>{' '}
      </Content>
